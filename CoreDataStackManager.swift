...
private let SQLITE_FILE_NAME = "MedicalMinder.sqlite"
...
class CoreDataStackManager {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("MedicalMinderModel", withExtension: "momd")!
    ...
    */
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        do {
            ...
            let wrappedError = NSError(domain: "MEDICALMINDER", code: 9999, userInfo: dict)
